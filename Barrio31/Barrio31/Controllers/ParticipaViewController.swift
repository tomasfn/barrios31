...
class ParticipaViewController: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        mapButton.addTarget(self, action: #selector(ParticipaViewController.mapButtonpressed), for: .touchUpInside)
        ...
        listButton.addTarget(self, action: #selector(ParticipaViewController.listButtonpressed), for: .touchUpInside)
    ...
    func loadData() {
        SVProgressHUD.show()
        APIManager.getParticipa { (participaItem, error) in
            //SVProgressHUD.dismiss()
            if error == nil {
                self.items.append(contentsOf: participaItem!)
...
extension ParticipaViewController : UITableViewDataSource, UITableViewDelegate {
...
extension ParticipaViewController : MKMapViewDelegate {
...
extension ParticipaViewController: CLLocationManagerDelegate {
...
extension ParticipaViewController: UIGestureRecognizerDelegate {}

extension ParticipaViewController: UICollectionViewDataSource , UICollectionViewDelegate {
